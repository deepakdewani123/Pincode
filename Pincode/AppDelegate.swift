...
//        print(paths[0])
        ...
        UINavigationBar.appearance().barTintColor = UIColor.darkRed()
        UINavigationBar.appearance().tintColor = UIColor.whiteColor()
        
        UISearchBar.appearance().barTintColor = UIColor.darkRed()
        UISearchBar.appearance().tintColor = UIColor.whiteColor()
        UITextField.appearance().textColor = UIColor.darkRed()
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "deepakkumar.Pincode" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Pincode", withExtension: "momd")!
...
//        
        if !NSFileManager.defaultManager().fileExistsAtPath(url.path!) {
            var preloadURL: NSURL = NSURL.fileURLWithPath(NSBundle.mainBundle().pathForResource("SingleViewCoreData1", ofType: "sqlite")!)
            do {
...
//        if shortcutItem.type == "com.pincode.search" {
//            
//            let storyboard = UIStoryboard(name: "Main", bundle: nil)
//            
//            let detail = storyboard.instantiateViewControllerWithIdentifier("searchNavVC") as! UINavigationController
...
//            
//            
////            self.window.root?.presentViewController(addStuffVC, animated: false, completion: { () -> Void in
